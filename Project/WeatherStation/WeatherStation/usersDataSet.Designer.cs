...
namespace WeatherStation {
    ...
    public partial class usersDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UsersRow AddUsersRow(string FirstName, string LastName, string UserEmail, string UserPassword, string ConfirmPassword) {
            ...
            private void InitClass() {
                ...
                this.columnConfirmPassword.MaxLength = 25;
            }
...
namespace WeatherStation.usersDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Users] WHERE (([UserID] = @Original_UserID) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_UserEmail = 1 AND [UserEmail] IS NULL) OR ([UserEmail] = @Original_UserEmail)) AND ((@IsNull_UserPassword = 1 AND [UserPassword] IS NULL) OR ([UserPassword] = @Original_UserPassword)) AND ((@IsNull_ConfirmPassword = 1 AND [ConfirmPassword] IS NULL) OR ([ConfirmPassword] = @Original_ConfirmPassword)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Users] ([FirstName], [LastName], [UserEmail], [UserPassword], [ConfirmPassword]) VALUES (@FirstName, @LastName, @UserEmail, @UserPassword, @ConfirmPassword);
SELECT UserID, FirstName, LastName, UserEmail, UserPassword, ConfirmPassword FROM Users WHERE (UserID = SCOPE_IDENTITY())";
...
SELECT UserID, FirstName, LastName, UserEmail, UserPassword, ConfirmPassword FROM Users WHERE (UserID = @UserID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WeatherStation.Properties.Settings.Default.usersConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserID, FirstName, LastName, UserEmail, UserPassword, ConfirmPassword FROM" +
                " dbo.Users";
        ...
        public virtual int Delete(int Original_UserID, string Original_FirstName, string Original_LastName, string Original_UserEmail, string Original_UserPassword, string Original_ConfirmPassword) {
            ...
            if ((Original_ConfirmPassword == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[10].Value = ((string)(Original_ConfirmPassword));
            }
        ...
        public virtual int Insert(string FirstName, string LastName, string UserEmail, string UserPassword, string ConfirmPassword) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, string UserEmail, string UserPassword, string ConfirmPassword, int Original_UserID, string Original_FirstName, string Original_LastName, string Original_UserEmail, string Original_UserPassword, string Original_ConfirmPassword, int UserID) {
            if ((FirstName == null)) {
            ...
            if ((Original_ConfirmPassword == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[15].Value = ((string)(Original_ConfirmPassword));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string UserEmail, string UserPassword, string ConfirmPassword, int Original_UserID, string Original_FirstName, string Original_LastName, string Original_UserEmail, string Original_UserPassword, string Original_ConfirmPassword) {
            return this.Update(FirstName, LastName, UserEmail, UserPassword, ConfirmPassword, Original_UserID, Original_FirstName, Original_LastName, Original_UserEmail, Original_UserPassword, Original_ConfirmPassword, Original_UserID);
        }
    }
